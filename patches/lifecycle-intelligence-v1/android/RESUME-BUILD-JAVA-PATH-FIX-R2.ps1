...
Write-Host "DRIVELAB ANDROID LIFECYCLE BUILD RESUME - JAVA PATH FIX R2" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
$ReportLines = @(
    ...
    ""
    "Passed:"
    "- existing isolated stage and lifecycle markers"
    "- Java PATH correction using Android Studio JBR"
